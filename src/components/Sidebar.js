    ...
    return (
        <div className='bg-[#4E73DF] px-[25px] h-screen'>
            <div className='px-[15px] py-[30px] flex items-center justify-center border-b-[1px] border-[#EDEDED]/[0.3]'>
                <h1 className='text-white text-[20px] leading-[24px] font-extrabold cursor-pointer'>ResQ Jeevan</h1>
            </div>
            ...
            <div className='pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]'>
                ...
                <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer'>
                    ...
                    <div className='flex items-center gap-[10px]'>
                        <FaLocationDot  color='white' /> <p className='text-[14px] leading-[20px] font-normal text-white'>View Locations</p>
                    </div>
                    </Link>
                ...
                <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer'>
                    <div className='flex items-center gap-[10px]'>
                        <FaRegSun color='white' /> <p className='text-[14px] leading-[20px] font-normal text-white'>Rescue Trainee Status</p>
                    </div>
                    <FaChevronRight color='white' />
                </div>
                <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer'>
                    <div className='flex items-center gap-[10px]'>
                        <FaWrench color='white' /> <p className='text-[14px] leading-[20px] font-normal text-white'>Disaster Prediction</p>
                    </div>
                    <FaChevronRight color='white' />
                </div>
            </div>
